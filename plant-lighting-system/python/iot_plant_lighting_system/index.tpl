...
<html lang="en">
<head>
    <title>Plant Lighting System</title>
    <link rel="stylesheet" href="styles.css">
</head>
<body>
    <div class="container">
        <div class="col-md-12">
            <h1>Plant Lighting System</h1>
        </div>
        <div class="col-md-12" id="schedule">
            ...
            <button class="btn btn-success btn-lg" id="update">Update</button>
        </div>
        ...
        <div class="col-md-12" id="moisture">
            <h1>Moisture</h1>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    % for data in moisture:
                        <tr>
                            <td>{{data.get("time")}}</td>
                            <td>{{data.get("value")}}</td>
                        </tr>
                    % end
                </tbody>
            </table>
