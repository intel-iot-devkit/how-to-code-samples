...
If a close call is detected (the Grove* IR Distance Interrupter is tripped), the Intel® Edison will, if configured, notify the "Intel IoT Example Datastore" running on your own Microsoft* Azure* account.
...
```
chmod 755 /tmp/doorbell;export SERVER="http://intel-examples.azurewebsites.net/counter/close-call/inc"; export AUTH_TOKEN="YOURTOKEN"
```
