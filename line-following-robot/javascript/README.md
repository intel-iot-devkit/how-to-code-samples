...
This line following robot application is part of a series of how-to Intel® Internet of Thins (IoT) code sample exercises using the Intel® IoT Developer Kit, Intel® Edison board, Intel® IoT Gateway, cloud platforms, APIs, and other technologies.
