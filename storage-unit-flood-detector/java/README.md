...
This storage unit flood detector application is part of a series of how-to Intel®Internet of Things (IoT) code sample exercises using the Intel® IoT Developer Kit, Intel® Edison development platform, cloud platforms, APIs, and other technologies.
...
Give the project the name "StorageUnitFloodDetector" and click Next.
...
Optionally, you can store the data generated by this sample program in a bac-kend database deployed using Microsoft Azure, IBM* Bluemix, or AWS*, along with Node.js, and a Redis data store.
