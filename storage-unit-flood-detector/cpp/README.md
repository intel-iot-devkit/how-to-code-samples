...
Optionally, the monitor also stores the moisture data using the Intel IoT Examples Datastore running in your own Microsoft* Azure* or IBM* Bluemix* account.
