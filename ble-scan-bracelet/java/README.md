...
This Bluetooth\* low energy scan bracelet application is part of a series of how-to Internet of Things (IoT) code sample exercises using the Intel® IoT Developer Kit, Intel® Edison development platform, cloud platforms, APIs, and other technologies.
...
Using an Intel® Edison board, this project lets you create a Bluetooth\* low energy scan bracelet that:<br>
- searches for Bluetooth\* low energy devices that come within its scanning range.<br>
...
This Bluetooth\* low energy scanner bracelet uses a Xadow* expansion board for the Intel® Edison platform and the OLED display included in the Xadow kit.

With these components, we'll make a simple Bluetooth\* low energy scanner that displays information on the OLED display when devices equipped with Bluetooth\* low energy enter or exit its scanning range.
...
### Set up the Intel® Edison board for Bluetooth\* low energy development

To set up the Intel® Edison board for Bluetooth\* low energy, run the following command:
