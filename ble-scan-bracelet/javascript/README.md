...
This Bluetooth* low energy scan bracelet application is part of a series of how-to IoT code sample exercises using the Intel® IoT Developer Kit, Intel® Edison development platform, cloud platforms, APIs, and other technologies.
