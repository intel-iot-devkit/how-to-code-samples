#  **DEPRECATED** Bluetooth\* low energy scan bracelet in JavaScript*

## Introduction

**Please note that this sample has been deprecated and is no longer supported.**

This Bluetooth* low energy scan bracelet application is part of a series of how-to Intel IoT code sample exercises using the Intel® IoT Developer Kit, Intel® Edison development platform, cloud platforms, APIs, and other technologies.
...
With these components, we'll make a simple BLE scanner that displays information on the OLED display when devices equipped with Bluetooth\* low energy enter or exit its scanning range.
...
### Set up Intel® Edison for Bluetooth\* low energy development

To set up Intel® Edison for Bluetooth\* low energy, run the following command:
